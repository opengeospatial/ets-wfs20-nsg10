...
/**
 * Enhanced the {@link org.opengis.cite.iso19142.util.WFSClient} by the support of
 * transforming PageResults POST binding requests to GET query string
 *
...
public class NsgWfsClient extends WFSClient {
	...
	/**
	 * <p>
	 * Constructor for NsgWfsClient.
	 * </p>
	 * @param wfsMetadata a {@link org.w3c.dom.Document} object
	 */
	 ...
	 * @param entity never <code>null</code>
	...
	private void appendResultSetId(StringBuilder sb, Node entity) throws XPathExpressionException {
	...
	private String parseValue(Node entity, String parameter, String defaultValue) throws XPathExpressionException {
