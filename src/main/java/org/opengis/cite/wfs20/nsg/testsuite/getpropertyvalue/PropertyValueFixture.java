...
public class PropertyValueFixture extends BaseFixture {
    ...
    /**
     * Builds a DOM Document node representing the entity body for a GetPropertyValue request. A minimal XML
     * representation is read from the classpath (at util/GetPropertyValue.xml).
     */
    @BeforeMethod
