...
/**
 * Tests if the capabilities populates the Service Constraints of the OperationsMetadata
 * document as described in Section 8.1.3.3.1. (see NSG WFS 2.0 Profile, 8.1.3.3.1 Service
 * Constraints, Table 15 : WFS Service Constraints).
 *
...
public class ServiceConstraints extends BaseFixture {
	...
	/**
	 * <p>
	 * serviceConstraintImplementsTransactionalWFS.
	 * </p>
	...
	/**
	 * <p>
	 * serviceConstraintImplementsResultPaging.
	 * </p>
	 * @param testContext a {@link org.testng.ITestContext} object
	 */
	@Test(description = "See NSG WFS 2.0 Profile: Requirement 26")
	...
	/**
	 * <p>
	 * serviceConstraintImplementsStandardJoins.
	 * </p>
	 * @param testContext a {@link org.testng.ITestContext} object
	 */
	@Test(description = "See NSG WFS 2.0 Profile: Requirement 26")
	...
	/**
	 * <p>
	 * serviceConstraintImplementsSpatialJoins.
	 * </p>
	 * @param testContext a {@link org.testng.ITestContext} object
	 */
	@Test(description = "See NSG WFS 2.0 Profile: Requirement 26")
	...
	/**
	 * <p>
	 * serviceConstraintImplementsTemporalJoins.
	 * </p>
	 * @param testContext a {@link org.testng.ITestContext} object
	 */
	@Test(description = "See NSG WFS 2.0 Profile: Requirement 26")
	...
	/**
	 * <p>
	 * serviceConstraintImplementsFeatureVersioning.
	 * </p>
	 * @param testContext a {@link org.testng.ITestContext} object
	 */
	@Test(description = "See NSG WFS 2.0 Profile: Requirement 26")
	...
	/**
	 * <p>
	 * serviceConstraintImplementsEnhancedPaging.
	 * </p>
	 * @param testContext a {@link org.testng.ITestContext} object
	 */
	@Test(description = "See NSG WFS 2.0 Profile: Requirement 26")
	...
	private void assertTrueOrFalse(String constraintValue, String constraint) {
		...
		assertTrue(isTrueOrFalse,
				"The constraint " + constraint + " must be declared and the value must be TRUE or FALSE");
	}
