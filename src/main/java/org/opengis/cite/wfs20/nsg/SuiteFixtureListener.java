...
public class SuiteFixtureListener implements ISuiteListener {
    ...
    void processSuiteParameters( ISuite suite ) {
        ...
        try {
            entityFile = URIUtils.resolveURIAsFile( iutRef );
        ...
        try {
            iutDoc = URIUtils.resolveURIAsDocument( entityFile.toURI() );
        } catch ( Exception x ) {
     ...
     */
    /*
     * void registerClientComponent( ISuite suite ) { Client client = ClientUtils.buildClient(); if ( null != client ) {
