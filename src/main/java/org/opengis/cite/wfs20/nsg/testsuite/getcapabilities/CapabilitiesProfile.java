...
public class CapabilitiesProfile extends BaseFixture {
    ...
    private static final List<String> EXPECTED_LOCKING_PROFILE = asList( "http://www.nga.mil/service/wfs/2.0/profile/locking",
                                                                         "urn:nga:service:wfs:2.0:profile:locking" );
