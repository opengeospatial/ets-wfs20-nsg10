package org.opengis.cite.wfs20.nsg.level1;

import java.io.IOException;
import java.net.URL;
import javax.xml.transform.Source;
import javax.xml.transform.dom.DOMSource;
import org.opengis.cite.wfs20.nsg.CommonFixture;
import org.opengis.cite.wfs20.nsg.ErrorMessage;
import org.opengis.cite.wfs20.nsg.ErrorMessageKeys;
import org.opengis.cite.wfs20.nsg.SuiteAttribute;
...
public class Capability1Tests extends CommonFixture {
     ...
     * {@link org.opengis.cite.wfs20.nsg.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/wfs20/nsg/rnc/atom.rnc");
