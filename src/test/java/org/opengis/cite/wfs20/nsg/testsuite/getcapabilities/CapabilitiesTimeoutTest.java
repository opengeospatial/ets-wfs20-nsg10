...
public class CapabilitiesTimeoutTest {
	...
	@Test
	public void testCapabilitiesContainsTimeoutForGetFeature_Configured() throws Exception {
	...
	public void testCapabilitiesContainsTimeoutForGetFeature_NotConfigured() throws Exception {
	...
	public void testCapabilitiesContainsTimeoutForGetFeature_Invalid() throws Exception {
	...
	@Test(expected = AssertionError.class)
	public void testCapabilitiesContainsTimeoutForGetFeatureWithLock_Invalid() throws Exception {
		ITestContext testContext = createTestContext("/capabilities-withFailures.xml");
